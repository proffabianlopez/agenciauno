document.addEventListener("DOMContentLoaded", function () {
    ...
    // Validación y envío con AJAX para actualizar los números de serie
    // Lógica de JavaScript para manejar el envío del formulario
document.getElementById("serialFormUpdate").addEventListener("submit", function(event) {
    ...
    // Manejar el clic en el botón para ver los detalles del producto
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data && data.length > 0) {
                    fillProductDetailsModal(data); // Usamos la función para llenar el modal
